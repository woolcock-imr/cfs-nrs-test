...
_set_req=function(){
    ...
    var participant_uid="";
	if($vm.vm['__ID'].op.input!=undefined && $vm.vm['__ID'].op.input.record!=undefined) participant_uid=$vm.vm['__ID'].op.input.record.UID;
...
_new_pre_data_process=function(){
    ...
    if(participant_record!=undefined && participant_record.UID!=undefined){
		_records[0].Participant_uid=participant_record.UID;
		_records[0].Participant=participant_name(participant_record);
    }
}
//-------------------------------------
